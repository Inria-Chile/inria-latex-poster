...
\usepackage[backend=biber, bibstyle=apa, autocite=superscript, defernumbers=true, citestyle=numeric]{biblatex}
\usepackage{csquotes}
...
% DO NOT change the "this-paper" key.
\begin{filecontents*}[noheader,overwrite]{self.bib}
  @inproceedings{this-paper,
    ...
    editor      = {Editor One and Another Editor and Thrid Editor},
...
% Avoid that our paper shows up in bibliography
\DeclareBibliographyCategory{thispapercat}
\addtocategory{thispapercat}{this-paper}
\AtBeginBibliography{\onehalfspacing}
      ...
      \begin{columns}[T]
        \begin{column}{.485\linewidth}
          \begin{inriastartblock}{Context}
            \begin{itemize}
              \item \TeX and \LaTeX\ \autocite{knuth:tex} are to  computer scientists what Latin was to ancient scholars.
              \item This is true even in the era of AI \autocite{russell2020artificial}.
              \item Can a poster be automated \autocite{hu2026postermeldmultiagentpapertopostergeneration}?
              \item This raises the question: \textbf{what is the meaning of life without posters?}
            \end{itemize}
        \end{inriastartblock}
        \begin{inriablock}{An Inria-theme \LaTeX\ poster}
            \begin{itemize}
              \item This is a poster template based on beamer.
              \item We have tried to capture the Inria charter with minimal variations.
              \item Also a starting point: please help and contribute.
            \end{itemize}
          \end{inriablock}
          ...
          \begin{inriablock}{Defining the Nice Looking Poster (NLP) Problem}
            ...
            \]
            \begin{itemize}
              \item $T(p)$: time dedicated to preparing the poster,
            ...
            \end{itemize}
            \begin{takeaway}
              As we already use \LaTeX\ for our papers, we will restrict $\set{P}$ to that domain.
            \end{takeaway}
          \end{inriablock}
          ...
          \begin{inriablock}{The specific Inria NLP instance}
            \begin{itemize}
              \item \textbf{Minimalist:} less is more; focus on the readability of the content.
              \item \textbf{Sophisticated:} these gradients are so cool.
              \item \textbf{Compliant:} should include the RF Inria logo.
                \begin{itemize}
                  \item Refer to the Inria charter for what to do if you want to include some logos.
          ...
          \begin{inriablock}{The (infinite) INLP loop}
            ...
            \begin{columns}[T]
              ...
              \begin{column}{0.45\textwidth}
                \centering
                \input{sample-figs/tikz-loop.tex}
              \end{column}
            \end{columns}
          \end{inriablock}
          ...
          \begin{plainblock}{}
            \begin{columns}[c]
              ...
              \begin{column}{0.9\textwidth}%
                {\linespread{0.83}\footnotesize\fullcite{this-paper}\\[-1.28ex]
...
\end{findingblock}
              ...
              \begin{itemize}
                ...
                \item \textbf{\texttt{Title of finding}}: title of the finding, can be empty.
                \item \textbf{Note:} This is not part of the Inria charter, but it is a nice addition to the poster template.
              \end{itemize}
            \end{findingblock}
            ...
            \begin{findingblock}{Finding 2. This is actually cool.}{violet}
              \begin{columns}[T]
                ...
                \begin{column}{0.38\textwidth}
                  \input{sample-figs/tikz-findings-venn.tex}
                \end{column}
              \end{columns}
            \end{findingblock}
          ...
          \begin{inriafinalblock}{Final remarks}
            ...
            \end{itemize}
          \end{inriafinalblock}
          % In general, it does not make sense to include a bibliography, but here you have it in case you need it.
          \begin{plainblock}{\small References}
            %%\renewcommand*{\bibfont}{\footnotesize}
            \setlength{\bibitemsep}{0.29em}
            \printbibliography[notcategory=thispapercat]
          \end{plainblock}
