...
\begin{columns}[T]
    ...
    \end{columns}
% \begin{itemize}
%     \item \textbf{Checks before printing:} Print drafts before printing the definitive one.
%               \begin{itemize}
%                 \item Some thin lines might not print well.
%                 \item Colors might be different on the screen and in the printed version.
%               \end{itemize}
%   \end{itemize}
\end{inriablock}
...
\begin{column}{.485\linewidth}
    \begin{plainblock}{}
        ...
        \begin{findingblock}{Finding 4. Columns inside your findings are your friend.}{violet}
            \begin{columns}[T]
                ...
                \begin{column}{0.6\textwidth}
                    \centering
                    %\input{sample-figs/tikz-rose-plots}
                \end{column}
            \end{columns}
        \end{findingblock}
    \end{plainblock}
    ...
    \begin{inriafinalblock}{Final remarks}
        \begin{itemize}
            ...
            \item Made with \faHeart\ by Inria Chile.
        \end{itemize}
    \end{inriafinalblock}
\end{column}
\end{columns}
...
%\begin{plainblock}{}  %{TL;DR}
% \begin{columns}[t]
%     \begin{column}{0.4\linewidth}
%     \begin{inriablock}{}
%         \large Evolutionary symbolic regression improves when domain-specific priors are used to initialize search.
%     \end{inriablock}
%     \end{column}
%     \begin{column}{0.29\linewidth}
%     \begin{plainblock}{}
%         \large \ldots but, \tcblower \large \textbf{What defines a good set of priors?}
%     \end{plainblock}
%     \end{column}
%     \begin{column}{0.29\linewidth}
%     \begin{inriafinalblock}{}
%         \large We evaluate priors along two axes: \tcblower\large\textcolor{inria-rouge}{\textbf{coverage}} and \textcolor{inria-rouge}{\textbf{diversity}}.
%     \end{inriafinalblock}
%     \end{column}
% \end{columns}
